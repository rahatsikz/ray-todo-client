...
const TodoCard = ({ todo }) => {
  ...
  const handleEdit = (e) => {
    ...
    axios
      .patch(`https://ray-todo-server.vercel.app/todo/${_id}`, {
        title,
        description,
        dueDate: startDate,
      })
  ...
  const handleDelete = () => {
    ...
    if (proceed) {
      // console.log(_id);
      axios.delete(`https://ray-todo-server.vercel.app/delete/${_id}`).then(
        (response) => {
          console.log(response);
  ...
  const handleDone = () => {
    ...
    if (proceed) {
      axios.patch(`https://ray-todo-server.vercel.app/done/${_id}`).then(
        (response) => {
          console.log(response);
